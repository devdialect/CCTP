...
local guide2Texture = "citizenGuide2.dds"; --MOD
local laborerTexture = "citizenLaborer.dds"; --MOD
local intellectualTexture = "citizenIntellectual.dds"; --MOD
local energyTexture = "citizenGuide.dds"; --MOD
local entertainerexture = "citizenEntertainer.dds"; --MOD
...
function AddBuildingButton( pCity, building )
	...
	if (pCity:IsHasBuilding(buildingID)) and building.IsVisible then --PLAGUE MOD support for compatibility
		...
		if building.SpecialistType then
			...
			elseif building.SpecialistType == "SPECIALIST_GUIDE" then --MOD
				controlTable.BuildingFilledSpecialistSlot1:SetTexture(guide2Texture);
				controlTable.BuildingFilledSpecialistSlot2:SetTexture(guide2Texture);
				controlTable.BuildingFilledSpecialistSlot3:SetTexture(guide2Texture);
			elseif building.SpecialistType == "SPECIALIST_INTELECTUAL" then --MOD
				controlTable.BuildingFilledSpecialistSlot1:SetTexture(intellectualTexture);
				controlTable.BuildingFilledSpecialistSlot2:SetTexture(intellectualTexture);
				controlTable.BuildingFilledSpecialistSlot3:SetTexture(intellectualTexture);
			elseif building.SpecialistType == "SPECIALIST_LABORER" then --MOD
				controlTable.BuildingFilledSpecialistSlot1:SetTexture(laborerTexture);
				controlTable.BuildingFilledSpecialistSlot2:SetTexture(laborerTexture);
				controlTable.BuildingFilledSpecialistSlot3:SetTexture(laborerTexture);
			elseif building.SpecialistType == "SPECIALIST_ENERGY" then --MOD
				controlTable.BuildingFilledSpecialistSlot1:SetTexture(energyTexture);
				controlTable.BuildingFilledSpecialistSlot2:SetTexture(energyTexture);
				controlTable.BuildingFilledSpecialistSlot3:SetTexture(energyTexture);
			elseif building.SpecialistType == "SPECIALIST_ENTERTAINER" then --MOD
				controlTable.BuildingFilledSpecialistSlot1:SetTexture(entertainerexture);
				controlTable.BuildingFilledSpecialistSlot2:SetTexture(entertainerexture);
				controlTable.BuildingFilledSpecialistSlot3:SetTexture(entertainerexture);
			elseif building.SpecialistType == "SPECIALIST_ENVIRONMENT" then --MOD
				controlTable.BuildingFilledSpecialistSlot1:SetTexture(engineerTexture);
				controlTable.BuildingFilledSpecialistSlot2:SetTexture(engineerTexture);
				controlTable.BuildingFilledSpecialistSlot3:SetTexture(engineerTexture);
			else			
...
--		UpdateSpecialists(pCity);
		...
		if (Game.IsOption(GameOptionTypes.GAMEOPTION_NO_RELIGION)) then
			...
			local iFaithPerTurn = pCity:GetFaithPerTurn(); --MOD
		...
		-- local happiness
		local lochap = pCity:GetLocalHappiness() - pCity:GetPopulation();
		locstr = "TXT_KEY_CITYVIEW_PERTURN_TEXT";
		if lochap < 0 then
			locstr = "TXT_KEY_CITYVIEW_PERTURN_TEXT_NEGATIVE";
		end
		Controls.LocalHappinessLabel:SetText( Locale.ConvertTextKey(locstr, lochap) );
		--------------------
...
function DoUpdateUpperLeftTooltips()
	...
	Controls.TourismBox:SetToolTipString(strTourismToolTip);
			-- EMIGRATION MOD --
	local strProspToolTip = GetProsperityTooltip(pCity);
	Controls.ProsperityBox:SetToolTipString(strProspToolTip);
end
