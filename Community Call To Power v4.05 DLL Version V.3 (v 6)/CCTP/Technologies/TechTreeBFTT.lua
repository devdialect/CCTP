...
local g_PipePrehis1 = InstanceManager:new( "TechPipeInstance", "TechPipeIcon", Controls.Prehis1TechTreeScrollPanel );
local g_TechInstancePrehis1 = InstanceManager:new( "TechButtonInstance", "TechButton", Controls.Prehis1TechTreeScrollPanel );
local g_PipePrehis2 = InstanceManager:new( "TechPipeInstance", "TechPipeIcon", Controls.Prehis2TechTreeScrollPanel );
local g_TechInstancePrehis2 = InstanceManager:new( "TechButtonInstance", "TechButton", Controls.Prehis2TechTreeScrollPanel );
local g_PipePrehis3 = InstanceManager:new( "TechPipeInstance", "TechPipeIcon", Controls.Prehis3TechTreeScrollPanel );
local g_TechInstancePrehis3 = InstanceManager:new( "TechButtonInstance", "TechButton", Controls.Prehis3TechTreeScrollPanel );
...
function InitialSetup()
	...
	Controls.Prehis1TechTreeScrollBar:SetSizeX( Controls.Prehis1TechTreeScrollPanel:GetSize().x - 150 );
	Controls.Prehis2TechTreeScrollBar:SetSizeX( Controls.Prehis2TechTreeScrollPanel:GetSize().x - 150 );
	Controls.Prehis3TechTreeScrollBar:SetSizeX( Controls.Prehis3TechTreeScrollPanel:GetSize().x - 150 );
	...
	Controls.RWTechTreeScrollBar:SetSizeX( Controls.RWTechTreeScrollPanel:GetSize().x - 150 );
	...
	for row in GameInfo.Technology_PrereqTechs() do
		...
		if tech and prereq then
			...
			if tech.TechCat == "TECHTREE_PREHIS1" and prereq.TechCat == "TECHTREE_PREHIS1" then
				g_PipeManager = g_PipePrehis1
				PCat = "TECHTREE_PREHIS1"
			elseif tech.TechCat == "TECHTREE_PREHIS2" and prereq.TechCat == "TECHTREE_PREHIS2" then
				g_PipeManager = g_PipePrehis2
				PCat = "TECHTREE_PREHIS2"
			elseif tech.TechCat == "TECHTREE_PREHIS3" and prereq.TechCat == "TECHTREE_PREHIS3" then
				g_PipeManager = g_PipePrehis3
				PCat = "TECHTREE_PREHIS3"
			elseif tech.TechCat == "TECHTREE_LAND" and prereq.TechCat == "TECHTREE_LAND" then
			...
			elseif tech.TechCat == "TECHTREE_MOLECULE" and prereq.TechCat == "TECHTREE_MOLECULE" then
				...
				PCat = "TECHTREE_MOLECULE"
			elseif tech.TechCat == "TECHTREE_ENVIRONMENT" and prereq.TechCat == "TECHTREE_ENVIRONMENT" then
				g_PipeManager = g_PipeEnvironment
				PCat = "TECHTREE_ENVIRONMENT"
	...
	for pipeIndex, thisPipe in pairs(techPipes) do
		...
		local PCat = NULL
			...
			if tech.TechCat == "TECHTREE_PREHIS1" then
				g_PipeManager = g_PipePrehis1
				PCat = "TECHTREE_PREHIS1"
			elseif tech.TechCat == "TECHTREE_PREHIS2" then
				g_PipeManager = g_PipePrehis2
				PCat = "TECHTREE_PREHIS2"
			elseif tech.TechCat == "TECHTREE_PREHIS3" then
				g_PipeManager = g_PipePrehis3
				PCat = "TECHTREE_PREHIS3"
			elseif tech.TechCat == "TECHTREE_LAND" then
				g_PipeManager = g_PipeLand
				PCat = "TECHTREE_LAND"
			...
			elseif tech.TechCat == "TECHTREE_MOLECULE" then
				g_PipeManager = g_PipeMolecule
				PCat = "TECHTREE_MOLECULE"
			elseif tech.TechCat == "TECHTREE_ENVIRONMENT" then
				g_PipeManager = g_PipeEnvironment
				PCat = "TECHTREE_ENVIRONMENT"
		...
		-- End of Changes
				...
				pipe.TechPipeIcon:SetTexture(bottomRightTexture);
				pipe.TechPipeIcon:SetTextureOffset(Vector2(72,72));
			elseif thisPipe.rightConnectionType == 7 then
	...
	Controls.Prehis1TechTreeScrollPanel:CalculateInternalSize();
	Controls.Prehis2TechTreeScrollPanel:CalculateInternalSize();
	Controls.Prehis3TechTreeScrollPanel:CalculateInternalSize();
	...
	Controls.RWTechTreeScrollPanel:CalculateInternalSize();
...
function AddTechButton( tech )
		...
		if tech.TechCat == "TECHTREE_PREHIS1" then
			g_TechInstanceManager = g_TechInstancePrehis1
			PCat = "TECHTREE_PREHIS1"
		elseif tech.TechCat == "TECHTREE_PREHIS2" then
			g_TechInstanceManager = g_TechInstancePrehis2
			PCat = "TECHTREE_PREHIS2"
		elseif tech.TechCat == "TECHTREE_PREHIS3" then
			g_TechInstanceManager = g_TechInstancePrehis3
			PCat = "TECHTREE_PREHIS3"	
		elseif tech.TechCat == "TECHTREE_LAND" then
		...
		elseif tech.TechCat == "TECHTREE_MOLECULE" then
			...
			PCat = "TECHTREE_MOLECULE"
		elseif tech.TechCat == "TECHTREE_ENVIRONMENT" then
			g_TechInstanceManager = g_TechInstanceEnvironment
			PCat = "TECHTREE_ENVIRONMENT"
		elseif tech.TechCat == "TECHTREE_ELECTRICAL_PHENOMENA" then
...
function OnDisplay( popupInfo )
	...
	if (popupInfo.Data1 == 890) then
		TechPageDesc = Locale.ConvertTextKey( "TXT_KEY_CCTP_TECHPAGE_PREHIS1" );
		Controls.Tech_Tree_Label:SetText( TechPageDesc );
		Controls.Prehis1TechTreeScrollPanel:SetHide(false);
		Controls.Prehis2TechTreeScrollPanel:SetHide(true);
		Controls.Prehis3TechTreeScrollPanel:SetHide(true);
		...
		Controls.RWTechTreeScrollPanel:SetHide(true);
	...
	elseif (popupInfo.Data1 == 891) then
		TechPageDesc = Locale.ConvertTextKey( "TXT_KEY_CCTP_TECHPAGE_PREHIS2" );
		Controls.Tech_Tree_Label:SetText( TechPageDesc );
		Controls.Prehis1TechTreeScrollPanel:SetHide(true);
		Controls.Prehis2TechTreeScrollPanel:SetHide(false);
		Controls.Prehis3TechTreeScrollPanel:SetHide(true);
		Controls.LandTechTreeScrollPanel:SetHide(true);
		Controls.SeaTechTreeScrollPanel:SetHide(true);
		Controls.SpiritTechTreeScrollPanel:SetHide(true);
		...
		Controls.AtomMTechTreeScrollPanel:SetHide(true);
		Controls.FringeTechTreeScrollPanel:SetHide(true);
	elseif (popupInfo.Data1 == 892) then
			TechPageDesc = Locale.ConvertTextKey( "TXT_KEY_CCTP_TECHPAGE_PREHIS3" );
		Controls.Tech_Tree_Label:SetText( TechPageDesc );
		Controls.Prehis1TechTreeScrollPanel:SetHide(true);
		Controls.Prehis2TechTreeScrollPanel:SetHide(true);
		Controls.Prehis3TechTreeScrollPanel:SetHide(false);
		Controls.LandTechTreeScrollPanel:SetHide(true);
		Controls.SeaTechTreeScrollPanel:SetHide(true);
		Controls.SpiritTechTreeScrollPanel:SetHide(true);
		Controls.NumberTechTreeScrollPanel:SetHide(true);
		...
		Controls.AtomMTechTreeScrollPanel:SetHide(true);
		Controls.FringeTechTreeScrollPanel:SetHide(true);
	elseif (popupInfo.Data1 == 901) then
