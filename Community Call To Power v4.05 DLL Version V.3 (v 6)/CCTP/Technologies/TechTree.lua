...
local g_TechPageButtonManager1 = InstanceManager:new( "TechPageButton", "OpenTechPageButton", Controls.PrehistoricButtonStack );
local g_TechPageButtonManager2 = InstanceManager:new( "TechPageButton", "OpenTechPageButton", Controls.AncientButtonStack );
local g_TechPageButtonManager3 = InstanceManager:new( "TechPageButton", "OpenTechPageButton", Controls.Classical1ButtonStack );
local g_TechPageButtonManager4 = InstanceManager:new( "TechPageButton", "OpenTechPageButton", Controls.MedievalButtonStack );
local g_TechPageButtonManager5 = InstanceManager:new( "TechPageButton", "OpenTechPageButton", Controls.RenaissanceButtonStack );
local g_TechPageButtonManager6 = InstanceManager:new( "TechPageButton", "OpenTechPageButton", Controls.IndustrialButtonStack );
local g_TechPageButtonManager7 = InstanceManager:new( "TechPageButton", "OpenTechPageButton", Controls.ModernButtonStack );
local g_TechPageButtonManager8 = InstanceManager:new( "TechPageButton", "OpenTechPageButton", Controls.DigitalButtonStack );
local g_TechPageButtonManager9 = InstanceManager:new( "TechPageButton", "OpenTechPageButton", Controls.InformationButtonStack );
...
--]]
	...
	while TechPage ~= 925 do
		...
		local controlTable1 = g_TechPageButtonManager9:GetInstance();
		controlTable1.OpenTechPageButton:SetVoid1( TechPage ); -- indicates type
		controlTable1.OpenTechPageButton:SetVoid2( void );
...
function NotificationSelected (id)
	...
	--The id of the button indicates which technology tree the user wants to view, Firesforever 15/10/2010
		...
		Events.SerialEventGameMessagePopup( { Type = ButtonPopupTypes.BUTTONPOPUP_TECH_TREE, Data1=id, Data2=stealing  } );
...
-------------------------------------------------------------------------------
-------------------------------------------------------------------------------
function OnPrehistoricTechs( )

	Controls.EraPrehistoricSelectHighlight:SetHide(false);
	...
	Controls.EraPrehistoricScrollPanel:SetHide( false );
...
Controls.EraPrehistoric:RegisterCallback( Mouse.eLClick, OnPrehistoricTechs );
function OnAncientTechs( )

	Controls.EraPrehistoricSelectHighlight:SetHide(true);
	...
	-- Show the selected policies and hide the rest
	Controls.EraPrehistoricScrollPanel:SetHide( true );
